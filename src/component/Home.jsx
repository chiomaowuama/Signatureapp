    ...
    <div className=' landscape w-full h-screen'>
      <div className='landscapes  w-full h-full flex  justify-center items-center'>
        <div className='space-y-8 w-4/6  text-4xl text-white capitalize font-bigtext  px-2 '>
          <p><span className='text-5xl hover:text-red-800'>S</span>igns understands that a signature is your unique identity. the opportunity to help you discover what identity best workd securely for you is our goal click here to create your forever siggnature</p>
